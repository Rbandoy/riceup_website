...
export function Products() {
  return (
    <div className="flex  flex-col w-full justify-center items-center mt-[3rem]">
      <div class="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 auto-rows-fr">
        {
          [
            {
              id: 1,
          ...
          className="cursor-pointer grid grid-rows-2 bg-card w-[15rem] h-[25rem] border-2 hover:border-secondary hover:border-2">
            ...
            <div className="flex bg-card flex-col items-center row-span-1 col-span-2 border-t-2 border-borderColor text-primaryText">
